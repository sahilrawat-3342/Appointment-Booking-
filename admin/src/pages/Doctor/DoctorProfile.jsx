                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
...

                    {
                        isEdit
                            ...
                            : <button onClick={() => setIsEdit(prev => !prev)} className='px-4 py-1 border border-blue-400 text-sm rounded-full mt-5 hover:bg-blue-400 hover:text-white transition-all'>Edit</button>
                    }
